...
public class IndicatorViewPager {
	...
	//用于切换indicatorView
	public void changeindicatorView(Indicator indicator, final int currentItem){
		this.indicatorView = indicator;
		if (this.indicatorView.getAdapter() == null) {
			this.indicatorView.setAdapter(adapter.getIndicatorAdapter());
		}
		if (this.indicatorView.getOnItemSelectListener() == null) {
			this.indicatorView.setOnItemSelectListener(onItemSelectedListener);
		}
		this.indicatorView.setCurrentItem(currentItem);
	}
	/**
	 * 设置适配器
	 *
	...
	private Indicator.OnItemSelectedListener onItemSelectedListener = new Indicator.OnItemSelectedListener() {
		...
		public void onItemSelected(View selectItemView, int select, int preSelect) {
			...
			if (onIndicatorPageChangeListener != null) {
				onIndicatorPageChangeListener.onIndicatorPageChange(indicatorView.getPreSelectItem(), select);
			}
		}
	};
