...
public class NetworkLogger {
    ...
    /**
     * Print log for define method. When information is too long, the NetworkLogger can also complete printing. The
     * equivalent of "{@code android.util.Log.i("Tag", "Message")}" "{@code NetworkLogger.print("i",
     * "Tag", "Message")}".
     *
